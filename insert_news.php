...
<body>
    ...
    <body>
        ...
        if (isset($_POST['add'])) {
            ...
            $mas     = $_POST["mas"];
            $tim11   = $_POST["tim1"];
            $sql = "INSERT INTO News (Name,details,date_pub) VALUES ('$name', '$mas', '$tim11')";
        ...
        <div class="form-container">
            <form action="insert_news.php" method="post" autocomplete="off">

                <div class="form-row">
                    <div class="form-group">
                        <label for="name" class="required"> عنوان الخبر</label>
                        <input type="text" id="name" name="name" class="form-control" placeholder="أدخل عنوان الخبر" required>
                    </div>
