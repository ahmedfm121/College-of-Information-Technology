...
<body>
    ...
    <header class="header">
        <div class="container">
            ...
            <nav class="nav">
                ...
                <a href="programes.php">البرامج</a>
    ...
    <body>
        ...
        if (isset($_GET['edit'])) {
            ...
            $sql = "select * from academic where id_Academic=" . $id;
        ...
        if (isset($_POST['update'])) {
            ...
            if ($number <= 0) {
                echo "<script>alert('خطأ: رقم المعرف غير صالح'); window.location='department.php';</script>";
                exit;
            }
            ...
            data_start='$tim11',
            data_update='$tim22'
            where id_Academic='$number'";

            $r = mysqli_query($con, $sql);

            if ($r) {
                echo "<script>alert('تم التعديل بنجاح'); window.location='department.php';</script>";
            } else {
                echo "<script>alert('فشل التعديل');</script>";
            }
        }
        ?>
